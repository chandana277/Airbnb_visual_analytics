        ...
        var vis = function(){
          ...
          circles.on("mouseover", function(d){
            ...
            if (colorVar) {
              ...
              colorCategory.text(function(x){
                console.log(d[x]);
                document.getElementById('image').style.opacity="1";
                document.getElementById('image').innerHTML = '<img width="400" height="400" src="http://localhost:5000/load_images'+x+'-'+d[x]+'"/>';
                return x + ":  " + d[x]})
                .style("color", function(x){return color(d[x]);});
            }
      ...
      var cluster=function(){
        var option = document.querySelector('input[name="options"]:checked').value//getElementById("options").value
        console.log(option);
        if (option=="cluster-based"){
        database="http://localhost:5000/kmeans";}
        else{
          database="http://localhost:5000/color";}
        loadData();
      }
      var radviz= function(){
        database="http://localhost:5000/load_files";
        console.log(database);
        loadData();
      }
      var new1 =function(){

        database="http://localhost:5000/new1";
        loadData();
      }
